CLASS zcl_generate_travel_data_583 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS zcl_generate_travel_data_583 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF ztravel_583.
    ...
    DELETE FROM ztravel_583.

    " insert the new table entries
    INSERT ztravel_583 FROM TABLE @itab.
