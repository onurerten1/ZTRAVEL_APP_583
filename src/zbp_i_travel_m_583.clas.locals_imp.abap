CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    TYPES tt_travel_update TYPE TABLE FOR UPDATE ZI_Travel_M_583.
...
CLASS lhc_Travel IMPLEMENTATION.
  METHOD get_instance_features.
    READ ENTITY zi_travel_m_583 FROM VALUE #( FOR keyval IN keys
                                              ( %key                    = keyval-%key
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF zi_travel_m_583 IN LOCAL MODE
           ENTITY travel
    ...
    READ ENTITIES OF zi_travel_m_583 IN LOCAL MODE
         ENTITY travel
  ...
  METHOD validateAgency.
    READ ENTITY zi_travel_m_583\\travel FROM VALUE #( FOR <root_key> IN keys
  ...
  METHOD validateCustomer.
    ...
    " Raise msg for non existing customer id
    LOOP AT lt_travel INTO DATA(ls_travel).
      IF ls_travel-customer_id IS NOT INITIAL AND NOT line_exists( lt_customer_db[
